...
describe('bit.util', () => {
  it('bignumberWholePartToBitStringOfLength', () => {
    expect(bignumberWholePartToUnsignedBitStringOfLength(new BigNumber(128), BitLength.B8)).toEqual(
      '0b10000000',
    );
  ...
  it('fixedLengthBitStringByteArray', () => {
    ...
    expect(fixedLengthBitStringByteArrayLE(bitStr2)).toEqual([0x78, 0x56, 0x34, 0x12]);
  });
});
